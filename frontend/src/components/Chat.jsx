    ...
    return (
        <>
            ...
            <div className="flex relative flex-grow overflow-hidden">
                {messages.length > 0 ? <Messages convo={convo} messages={messages} /> : <p className="p-2">No messages</p>}
                <div className="absolute bottom-4 left-4">
                    {{
                        'file': <div className="flex flex-col gap-2 p-2 border border-border-primary rounded-lg bg-bg-primary">
                            {
                                [
                        ...
                        'emoji': <Emojis disabled={loading} onClick={(e) => setMessage(msg => msg + e)} />,
                        'gif': <Gif onClick={(g) => sendMessage(true, g.media_formats.gif.url, "GIF")} />
                    }[modal]}
                </div>
            </div>
